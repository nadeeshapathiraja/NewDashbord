...
<body>
    ...
    <div class="container">
        ...
        <br />
        <br />
        <h3 align="center">Shoping Cart With PHP And MySql | Source Code By <a
                href="https://webdevtrick.com">Webdevtrick.com</a></h3><br />
        <br /><br />
        <?php
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="test.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span
